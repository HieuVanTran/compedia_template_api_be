...
public class PublishCompanyController extends GlobalExceptionHandler {
    ...
    public ResponseEntity<?> search(@RequestParam(name = "companyId", required = false) Long companyId,
                                    @RequestParam(name = "email", required = false) String email,
                                    @RequestParam(name = "publishName", required = false) String publishName,
                                    @RequestParam(name = "page") Integer page,
                                    @RequestParam(name = "size") Integer size,
                                    @RequestParam(name = "sortField", required = false) String sortField,
                                    @RequestParam(name = "sortOrder", required = false) String sortOrder,
                                    @RequestParam(name = "agentPeople", required = false) String agentPeople) {
        Page<PublishCompanyResponse> list = publishCompanyService.search(companyId, publishName, email, agentPeople, sortField, sortOrder, page, size);
